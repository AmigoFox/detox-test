# Сайт для отправки заявок в клинику
...
1. `1.jpg` — Главная страница сайта  
2. `2.jpg` — Модальное окно с формой заявки  
3. `3.jpg` — Форма заполнена и готова к отправке  
4. `4.jpg` — Сообщение об успешной отправке заявки  
5. `5.jpg` — Аккордеон с часто задаваемыми вопросами  
6. `6.jpg` — Пример ошибки при некорректных данных  
7. `7.jpg` — Общий вид страницы с контентом  
